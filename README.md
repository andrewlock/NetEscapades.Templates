...
1. You must have the latest version of the dotnet tooling. This comes with Visual Studio 2017 or from dot.net. 
2. Run `dotnet new --install NetEscapades.Templating::*` to install the project template. 
3. Run `dotnet new basicwebapi --help` to see how to select the feature of the project. 
